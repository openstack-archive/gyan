...
class Connection(object):
    ...
    def get_ml_model_by_uuid(self, context, ml_model_uuid):
        ...
        try:
            ...
            raise exception.CapsuleNotFound(ml_model=ml_model_uuid)
    ...
    def get_ml_model_by_name(self, context, ml_model_name):
        ...
        try:
            ...
            raise exception.CapsuleNotFound(ml_model=ml_model_name)
        except MultipleResultsFound:
    ...
    def destroy_ml_model(self, context, ml_model_id):
        ...
        with session.begin():
            ...
            count = query.delete()
            if count != 1:
                raise exception.CapsuleNotFound(ml_model_id)
    ...
    def _do_update_ml_model_id(self, ml_model_id, values):
        ...
        with session.begin():
            ...
            try:
                ...
                raise exception.CapsuleNotFound(ml_model=ml_model_id)
