...
class ComputeHost(base.GyanPersistentObject, base.GyanObject):
    ...
    def _from_db_object_list(db_objects, cls, context):
        ...
        return [ComputeHost._from_db_object(context, cls(context), obj)
    ...
    def get_by_uuid(cls, context, uuid):
        ...
        :param context: Security context
        :returns: a :class:`ComputeHost` object.
        """
    ...
    def list(cls, context, limit=None, marker=None,
        ...
        """Return a list of ComputeHost objects.
    ...
    def destroy(self, context=None):
        """Delete the ComputeHost from the DB.
    ...
    def save(self, context=None):
        """Save updates to this ComputeHost.
